...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- Styles -->
          <link href="{{ asset('css/agenda-video/globals.css') }}" rel="stylesheet">
          <link rel="stylesheet" href="{{ asset ('css/agenda-video/styleguide.css') }}"/>
          <link rel="stylesheet" href="{{ asset ('css/agenda-video/style.css')  }}"/>
          <link rel="stylesheet" href="{{ mix('css/app.css') }}">
          <link rel="stylesheet" href="{{ asset('css/navbar-sidebar.css') }}">
      </head>
      <body>
        <div class="navbar">
            <div class="frame-7"><p class="text-wrapper-9">KANTOR URUSAN AGAMA KOTA MALANG</p></div>
            <div class="frame-8">
