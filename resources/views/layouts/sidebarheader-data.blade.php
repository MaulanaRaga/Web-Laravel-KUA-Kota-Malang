...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
        ...
        <!-- Styles -->
        <link href="{{ asset('css/data-chart/globals.css') }}" rel="stylesheet">
        <link rel="stylesheet" href="{{ asset ('css/data-chart/styleguide.css') }}"/>
        <link rel="stylesheet" href="{{ asset ('css/data-chart/style.css')  }}"/>
          ...
          <div  class="side-bar">
            ...
            <div class="side-baricon-text-wrapper">
              <div class="side-baricon-text">
                <a href="{{ url('/beranda') }}" class="div-3">
                  <i class="fa-solid fa-house fa-2x"></i>
                  <div class="text-wrapper-17">Beranda</div>
                </a>
                <div class="side-bar-profil">
                  <i class="fa-solid fa-user fa-2x"></i>
                  <div class="text-wrapper-18">Profile</div>
                </div>
                <div class="div-3">
                  <i class="fa-solid fa-image fa-2x"></i>
                  <a href="{{ url('/agenda')}}">
                  <div class="text-wrapper-17">Agenda</div>
                </a>
                </div>
                <div class="div-3">
                  <i class="fa-solid fa-newspaper fa-flip-horizontal fa-2x"></i>
                  <div class="text-wrapper-17">Layanan</div>
                </div>
                <div class="side-bar-data">
                  <i class="fa-solid fa-chart-pie fa-2x"></i>
                  <div class="text-wrapper-17">Data</div>
                </div>
              </div>
            </div>
        </div>
